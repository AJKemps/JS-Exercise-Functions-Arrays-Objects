...
*/
// function getLastCarInfo(carData2) {
//   const theCar = carData2;
//   return `This is a ${theCar[carData2.length].car_make} ${theCar[carData2.length].car_model}`
// }

// console.log(getLastCarInfo(carData));

function getLastCarInfo(carData2) {
  const lastCar = carData2[carData2.length-1];
...
*/
function getModelYears(carData2) {
  
  let carYears = [];

  for (let i = 0; i < carData2.length; i++){
     carYears.push(carData2[i].car_year);
  }
  return carYears;
}
